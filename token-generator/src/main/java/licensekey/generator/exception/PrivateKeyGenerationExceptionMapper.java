...
/**
 * This is the mapper for {@link PrivateKeyGenerationException}.
 *
 * @since 1.0.0
 */
public class PrivateKeyGenerationExceptionMapper implements ExceptionMapper<PrivateKeyGenerationException> {
